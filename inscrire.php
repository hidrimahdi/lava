...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($v3 == 1 && $v4 == 1 && $v5 == 1 && $v4_1 == 1 && $v5_1 == 1 && $v6 == 1 && $v7 == 1 && $v8 == 1) {
        ...
        $query = "INSERT INTO compte (Nom, Prenom, mail, mp, adresse, num_tel, date_anniversaire, type) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
$stmt = $conn->prepare($query);
$stmt->execute([$nom, $prenom, $mail, $hashedPassword, $adresse, $num_tel, $date_anniversaire->format('Y-m-d'), 'user']);
