...
// Call the getConnexion method to get the PDO connection
...
// Fetch the results
$movie = new MoviesC();
$result = $movie->getMoviesWithCurrentDate();
...
?>
      ...
      <section class="cta">
        <div class="container">
          ...
          <div class="title-wrapper">
            <h2 class="cta-title">Sign up !</h2>

            <p class="cta-text">
                With an account, you can interact with us.
            </p>
          </div>
