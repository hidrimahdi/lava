        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="http://localhost/Project/Dashbord/View/tableProductAdmin.php" class="nav-item nav-link "><i class="fa fa-table me-2"></i>Products</a>
                        <a href="#" class="nav-item nav-link active"><i class="fa fa-table me-2"></i>Commands</a>
                </div>
            </nav>
        </div>
        <!-- Sidebar End -->
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-6">
                            <div class="col-sm-12 col-xl-6">
                                <h6 class="mb-4">List of commands</h6>
                                <table id="myTable" class="table table-striped" >  
                <thead>
                    <th><FONT COLOR="WHITE">ID</FONT></th>
                    <th><FONT COLOR="WHITE">Name</FONT></th>
                    <th><FONT COLOR="WHITE">Adress</FONT></th>
                    <th><FONT COLOR="WHITE">PhoneNumber</FONT></th>
                    <th><FONT COLOR="WHITE">ID Product</FONT></th>
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="align-img">
                            <FONT COLOR="WHITE"><?PHP echo $commande['id']; ?></FONT>
                        </td>
                        <td class="align-img">
                            <FONT COLOR="WHITE"><?PHP echo $commande['nom']; ?></FONT>
                        </td>
                        <td class="align-img">
                            <FONT COLOR="WHITE"><?PHP echo $commande['adresse']; ?></FONT>
                        </td>
                        <td class="align-img">
                            <FONT COLOR="WHITE"><?PHP echo $commande['num']; ?></FONT>
                        </td>
                        <td class="align-img">
                            <FONT COLOR="WHITE"><?PHP echo $commande['idProduit']; ?></FONT>
                        </td>
                        <td>
                            <div class="form-group">
                                <form method="POST" action="deleteCommandAdmin.php">
