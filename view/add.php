          ...
          <div class="col-md-12">
            ...
            <form id="form" name="form" action="#" method="post">
              ...
              <div class="p-3 p-lg-5 border">
                ...
                <div class="form-group row">
                  <div class="col-md-12">
                    <label for="c_message" class="text-black">category  <span class="text-danger">*</span></label>
                    <textarea name="category" id="category" cols="30" rows="7" class="form-control"></textarea>
                  </div>
                </div>
                <div class="form-group row">
                  <div class="col-md-12">
                    <label for="c_message" class="text-black">price  <span class="text-danger">*</span></label>
