...
function addMovie($imagePath, $name, $year, $type, $category_id, $tag1, $tag2, $tag3, $description) {
    // Handle file upload
    ...
    if ($uploadOk == 0) {
        ...
        if (move_uploaded_file($_FILES["image"]["tmp_name"], $targetFile)) {
            ...
            $imagePath = $targetFile;
                ...
                $stmt = $this->pdo->prepare("INSERT INTO movies (image, name, year, type, category_id, tag1, tag2, tag3, description)
                            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)");

$stmt->execute([$imagePath, $name, $year, $type, $category_id, $tag1, $tag2, $tag3, $description]);
